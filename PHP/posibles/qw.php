...
<input type="radio" name="check6">mujer
<br />
...
<input type="reset" value="borrar datos">
   ...
   echo "El nombre tecleado es: "; echo $_GET['nombre']; echo "<br />";
      
   echo "El apellido tecleado es: "; echo $_GET['apellido'];echo "<br />";
  echo "El email tecleado es: "; echo $_GET['email'];echo "<br />";
echo "La direccion tecleada es: "; echo $_GET['domicilio'];echo "<br />";echo "<br />";
...
echo "Comentarios: "; echo $_GET['Comentario']; echo "<br />";
